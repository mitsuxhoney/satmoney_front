...
export const metadata = {
    title: "KYC And Verification | satmoney.in",
};
          ...
          <Herobg />
                ...
                <div className="flex items-center">
                    <div>
                        ...
                        <p className=" text-[rgba(0,_0,_0,_0.70)] pt-3 lg:text-[1.1rem] text-justify">
                            ...
                            aspects people look for in the modern world. 
                            Software and Infrastructure
                            offers innovative solutions in KYC and
            ...
            >
                ...
                <p className="py-3 opacity-75 lg:text-[1.1rem] text-center">
                    Choose Software and Infrastructure for the most efficient and secure
